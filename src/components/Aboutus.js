...
const Aboutus = () => {
  return (
        ...
        <div className="container py-5">
            <div className="row g-5 align-items-center">
                ...
                <div className="col-lg-7"
                    ...
                    <h1 className="mb-4">Welcome to <span className="text-primary">World Tour</span></h1>
    ...
    <button className="btn btn-primary btn-primary-outline-0 btn-md-square back-to-top"><i
